    ...
    <Dialog.Root open={item} onOpenChange={handleChange}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="focus:outline-none data-[state=open]:animate-contentShow scrollbar border border-red-400 ">
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-[400px] max-h-[80vh] overflow-y-auto no-scrollbar border border-gray-900 px-5 py-8 bg-white z-50">
